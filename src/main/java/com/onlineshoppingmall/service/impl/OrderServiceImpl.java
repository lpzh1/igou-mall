...
import com.onlineshoppingmall.dao.*;
import com.onlineshoppingmall.pojo.*;
...
import com.onlineshoppingmall.vo.OrderItemVo;
import com.onlineshoppingmall.vo.OrderProductVo;
import com.onlineshoppingmall.vo.OrderVo;
import com.onlineshoppingmall.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("OnlineShoppingMall购物扫码支付，订单号：").append(outTradeNo).toString();
    ...
    public void closeOrder(int hour) {
        ...
        for (Order order : orderList) {
            ...
            for (OrderItem orderItem : orderItemList) {
                //一定要使用主键 where 条件，防止锁表，同时需要使用 MySQL 的 InnoDB 引擎
